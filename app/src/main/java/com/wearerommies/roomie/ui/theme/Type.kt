...
@Stable
class RommieTypography internal constructor(
    ...
    ): RommieTypography = RommieTypography(
        heading1B20,
        heading2Sb20,
        heading3M20,
        heading4B18,
    ...
    fun update(other: RommieTypography) {
...
@Composable
fun rommieTypography(): RommieTypography {
    return RommieTypography(
        heading1B20 = rommieTextStyle(
